          ...
          <div class="col-lg-10">
            ...
            {{ csrf_field() }}
              ...
              <div class="row" style="margin-top:10px">
                ...
                <div class="col-md-9 form-group">
                  <input type="text" name="faskes" class="form-control" value="{{ old('faskes') }}">
                  @if ($errors->has('faskes')) <label style="font-size:12px;color: #f44336;">{{ $errors->first('faskes') }}</label>@endif
                </div>
              </div>
