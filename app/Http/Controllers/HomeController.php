...
class HomeController extends Controller
{
    ...
    public function index()
    {
        if(Auth::user()->group==1){
            $total_keseluruhan = Antrian::where('status', 1)->where('status_hapus', 0)->count();
            ...
            return view('admin.beranda', compact('total_keseluruhan','jumlah_antrian','sudah_divaksin','belum_divaksin'));
        } else {
